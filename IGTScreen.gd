...
func fadein():
	if not exiting:
		...
		tween.add_attribute("modulate", Color.white, 0.5, times_label)
		
		tween.attribute("modulate", Color.darkblue, 0.5, names)
		tween.add_attribute("modulate", Color.white, 0.5, names)
		
		tween.add_attribute("modulate", Color.darkblue, 0.5, totaltime)
		tween.add_attribute("modulate", Color.white, 0.5, totaltime)
...
func fadeout():
	if not exiting:
		...
		tween.reset()
		tween.attribute("modulate", Color.darkblue, 0.5, names)
		tween.attribute("modulate", Color.darkblue, 0.5, times_label)
