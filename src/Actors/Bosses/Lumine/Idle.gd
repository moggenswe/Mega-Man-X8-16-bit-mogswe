...
func _Update(_delta) -> void :
	...
	if stage.currently_is(1):
		...
		tween.method("set_vertical_speed", 0.0, flyspeed.y * 1.25, 0.75)
		tween.add_method("set_vertical_speed", flyspeed.y, - flyspeed.y * 2.0, 1.2)
		tween.add_method("set_vertical_speed", - flyspeed.y * 2.0, flyspeed.y * 2.0, 1.2)
		tween.add_method("set_vertical_speed", flyspeed.y * 2.0, - flyspeed.y * 2.0, 1.2)
		tween.add_method("set_vertical_speed", - flyspeed.y * 2.0, flyspeed.y * 2.0, 1.2)
		tween.add_method("set_vertical_speed", flyspeed.y * 2.0, - flyspeed.y * 2.0, 1.2)
		tween.add_method("set_vertical_speed", - flyspeed.y * 2.0, flyspeed.y * 2.0, 1.2)
		tween.add_method("set_vertical_speed", flyspeed.y * 2.0, - flyspeed.y * 2.0, 1.2)
		tween.add_method("set_vertical_speed", - flyspeed.y * 2.0, flyspeed.y * 2.0, 1.2)
		tween.add_method("set_vertical_speed", flyspeed.y * 2.0, 0.0, 0.5)
		stage.next()
