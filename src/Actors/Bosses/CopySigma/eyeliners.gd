...
func rotate_eyes() -> void :
	...
	tween.add_attribute("rotation_degrees", positions[0] * direction, 0.7, ray)
	tween.add_attribute("rotation_degrees", positions[1] * direction, 0.67, ray)
	tween.add_attribute("rotation_degrees", positions[2] * direction, 0.57, ray)
	tween.add_attribute("rotation_degrees", positions[3] * direction, 0.47, ray)
