...
func activate():
	...
	Tools.timer(0.5, "start_visuals", self)
...
func start_visuals():
	...
	tween.method("set_radius", 0.65, 0.1, 2.3)
	tween.add_wait(0.55)
...
func death():
	...
	kanji.scale = Vector2(0.95, 0.95)
	tween.create(Tween.EASE_OUT, Tween.TRANS_SINE)
	tween.add_attribute("scale", Vector2(1.05, 1.05), 0.2, kanji)
